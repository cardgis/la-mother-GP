    ...
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      <div className="z-10 items-center justify-between w-full max-w-5xl font-mono text-sm lg:flex">
        <p className="flex justify-start w-full gap-3 pt-8 pb-6">
          <code className="font-mono text-lg font-bold">Home</code>
          <code className="font-mono text-lg font-bold">About-Us </code>
          <code className="font-mono text-lg font-bold">Contact</code>
        </p>
